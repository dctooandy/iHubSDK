#
#  Be sure to run `pod spec lint iHubSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Andychen"
  # spec.authors            = { "Andychen" => "rd-sw18@visionsecurity.com.tw" }
  # spec.social_media_url   = "https://twitter.com/Andychen"
